...
print("Hold down the mouse button to wind up your arm. Release and the snowball gets released as well. Use the arrow keys to switch directions. Try to hit the snowmen and stay alive as long as possible!")
print(" ")
print(" ")
